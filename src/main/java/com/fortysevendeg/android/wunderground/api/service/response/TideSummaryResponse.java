...
/**
 * TideSummaryResponse class
 */
public class TideSummaryResponse extends AbstractJSONResponse implements Serializable {
    ...
    public DataTideResponse getData() {
        return data;
    }

    public void setData(DataTideResponse data) {
        this.data = data;
    }
}
